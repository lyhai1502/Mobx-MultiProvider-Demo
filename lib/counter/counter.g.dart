...
mixin _$Counter on CounterBase, Store {
  Computed<int>? _$squareNumberComputed;

  @override
  int get squareNumber =>
      (_$squareNumberComputed ??= Computed<int>(() => super.squareNumber,
              name: 'CounterBase.squareNumber'))
          .value;
  Computed<String>? _$oddOrEvenComputed;

  @override
  String get oddOrEven =>
      (_$oddOrEvenComputed ??= Computed<String>(() => super.oddOrEven,
              name: 'CounterBase.oddOrEven'))
          .value;
